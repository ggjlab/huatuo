...
<div>			<!--块级封装-->
    <center>	<!--将图片和文字居中-->
    <img src="https://user-images.githubusercontent.com/68268861/188867876-fd3fe531-ce6c-49b5-baf3-cd781072cc9c.png"
         alt="Schematic view of Huatuo"
         style="zoom:30%"/>
    <br>		<!--换行-->
    Schematic view of Huatuo	<!--标题-->
    </center>
</div>
